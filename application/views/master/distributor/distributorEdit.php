        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Edit distributor</h1>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                        	...
                        	<form action="" method="post" enctype="multipart/form-data">
								...
								<input type="hidden" name="id" value="<?php echo $distributor->kd_distributor?>" />

								<div class="form-group">
									<label>Nama distributor</label>
									<input class="form-control <?php echo form_error('nama_distributor') ? 'is-invalid':'' ?>"
									 type="text" name="nama_distributor" placeholder="Nama distributor" value="<?php echo $distributor->nama_distributor ?>" required/>
								...
								<div class="form-group">
									...
									<textarea class="form-control <?php echo form_error('alamat_distributor') ? 'is-invalid':'' ?>"
									 name="alamat_distributor" placeholder="Alamat distributor..." required><?php echo $distributor->alamat_distributor ?></textarea>
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									<input maxlength="15" class="form-control <?php echo form_error('no_telp') ? 'is-invalid':'' ?>"
									 type="text" name="no_telp" placeholder="Nomor telepon" value="<?php echo $distributor->no_telp ?>"  required/>
									<div class="invalid-feedback">
