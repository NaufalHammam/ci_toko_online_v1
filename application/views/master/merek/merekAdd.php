        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Tambah merek</h1>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo site_url('master/mereks/add') ?>" method="post" enctype="multipart/form-data" >
                                <div class="form-group">
                                    <label>Nama merek</label>
                                    <input class="form-control <?php echo form_error('nama_merek') ? 'is-invalid':'' ?>"
                                     type="text" name="nama_merek" placeholder="Nama merek" required />
