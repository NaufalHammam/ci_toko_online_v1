                        	...
                        	<form action="" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input class="form-control <?php echo form_error('tanggal_masuk') ? 'is-invalid':'' ?>"
									 type="date" name="tanggal_masuk" placeholder="tanggal masuk" value="<?php echo $barang->tanggal_masuk ?>" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									<input class="form-control <?php echo form_error('harga_barang') ? 'is-invalid':'' ?>"
									 type="number" name="harga_barang" placeholder="harga barang" value="<?php echo $barang->harga_barang ?>" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									<input class="form-control <?php echo form_error('stok_barang') ? 'is-invalid':'' ?>"
									 type="number" name="stok_barang" placeholder="stok barang" value="<?php echo $barang->stok_barang ?>" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									<textarea class="form-control <?php echo form_error('keterangan') ? 'is-invalid':'' ?>"
									 name="keterangan" placeholder="keterangan barang..."><?php echo $barang->keterangan ?></textarea>
									<div class="invalid-feedback">
