                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <a href="<?php echo site_url('manager/laporanmasters/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    <tr>
                                        ...
                                        <td width="25px"> : </td>
                                        <td> <?php echo $laporanmaster->kegiatan ?> </td>
                                    </tr>
                                    <tr>
                                        <td width="150px">Waktu kegiatan</td>
                                        <td width="25px"> : </td>
                                        <td> <?php echo $laporanmaster->waktu_kegiatan ?> </td>
                                    </tr>
                                </table>
                            </div>
